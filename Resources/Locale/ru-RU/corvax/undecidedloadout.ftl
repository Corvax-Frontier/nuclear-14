...
undecided-loadout-category-spy-description =
    ...
    2 магазина 22lr пол пистолет, 1 стандартный набор пропитания.
...
undecided-loadout-category-ncr-spy-description =
    ...
    1 пистолет с глушителем, 2 магазина 22lr пол пистолет, 1 боевой нож, 1 стандартный набор пропитания.
...
undecided-loadout-category-spy-bos-description =
    ...
    1 пистолет с глушителем, 2 магазина 22lr пол пистолет, 1 сухой паёк.
