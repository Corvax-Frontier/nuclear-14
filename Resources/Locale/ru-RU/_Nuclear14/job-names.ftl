...
job-description-caravan-leader = Координируйте караванную компанию в регионе и заключайте торговые сделки с местным населением.
...
job-description-ncr-cadet = Младшие ранг в НКР. Докажите свою ценность, чтобы получить повышение.
job-name-ncr-soldier = солдат НКР
job-description-ncr-soldier = Основа любой армии. Солдаты слепо выполняют задачи сержанта на миссиях и рвутся на передовую в боевых столкновениях.
job-name-ncr-nco = сержант НКР
job-description-ncr-nco = Младший офицер в армии НКР. Возглавьте отряд солдат для защиты интересов НКР в регионе.
job-name-ncr-officer = офицер НКР
job-description-ncr-officer = Региональный лидер армии НКР. Выполняйте свою миссию, управляя выделенным вам взводом солдат.
