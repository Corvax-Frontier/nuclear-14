...
ent-ActionFabricateLollipop = Изготовить леденец
    .desc = Сделайте леденец, чтобы бедные больные смогли почувствовать вашу любовь.
ent-ActionFabricateGumball = Изготовить жвачку
    .desc = Ничто лучше жвачки не стимулирует мозговую активность!
ent-ActionToggleWagging = Переключить влияние
    .desc = Действие для переключения анимации виляния для маркировки хвоста, поддерживающей это.
