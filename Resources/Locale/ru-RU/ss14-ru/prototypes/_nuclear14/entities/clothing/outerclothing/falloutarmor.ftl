...
ent-N14ClothingOuterMidwestReconArmor = разведывательная броня Братства Стали
   .desc = Разведывательный доспех, разработанный Братством Среднегозапада и предназначенный исключительно для высокопоставленных членов организации.
