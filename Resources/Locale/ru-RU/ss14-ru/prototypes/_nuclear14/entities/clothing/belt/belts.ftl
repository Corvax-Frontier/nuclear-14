...
ent-ClothingBeltBoSMidwestWebbing = разгрузочный жилет Братства Стали
    .desc = это прочная и функциональная экипировка, обеспечивающая удобство и защиту в условиях пустоши. Оснащён множеством карманов для хранения снаряжения, он идеально подходит для бойцов, стремящихся к максимальной мобильности и подготовленности к любым вызовам.
