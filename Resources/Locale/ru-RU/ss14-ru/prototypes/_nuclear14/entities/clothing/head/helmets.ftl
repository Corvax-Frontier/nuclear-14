...
ent-N14ClothingHeadHatBrotherhoodMidwestHelmetRecon = разведывательный шлем Братства Стали
    .desc = Это высокотехнологичная экипировка, обеспечивающая отличную видимость в темноте. Оснащённый системой ночного видения, он позволяет бойцам эффективно выполнять задачи разведки и наблюдения в любых условиях.
